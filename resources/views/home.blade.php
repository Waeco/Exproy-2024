        ...
        <div class="container">
            ...
            <nav id="nav">
                <ul>
                    ...
                    <li> <a href="">Central de abastos</a>
                        <ul>
                            <li><a href="#"></a></li>
            ...
            <div id="banner">
                ...
                <div class="container">
                    <section>
                        <header class="major">
                            <h2>Bienvenido a Amarant!</h2>
                            <span class="byline">Amarant tuvo sus inicios como pequeño negocio familiar en los años 70s
                                con la elaboración de diversos dulces típicos mexicanos en los que destaco la
                                palanqueta.
    ...
    <div class="wrapper style2">
        <section class="container">
            <header class="major">
                ...
                <span class="byline">Palanquetas Amarant</span>
            </header>
                            ...
                            <ul class="style">
                                <li>
                                    ...
                                    <span>In posuere eleifend odio. Quisque semper augue mattis wisi. Maecenas ligula.
                                        Pellentesque viverra vulputate enim.</span>
                                </li>
                                <li>
